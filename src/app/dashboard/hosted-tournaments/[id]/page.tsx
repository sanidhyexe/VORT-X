...
import { useTournaments, Registration, Feedback, KickRequest } from '@/context/tournament-context'
import {
  Card,
  CardContent,
  CardDescription,
...
export default function ManageTournamentPage() {
  ...
  const handleDeleteTournament = () => {
    ...
    router.push('/dashboard/hosted-tournaments')
  }
      ...
      <div className="container p-4 sm:p-6">
        <div className="mx-auto max-w-4xl space-y-6">
          <Button asChild variant="ghost" className="-ml-4">
            <Link href="/dashboard/hosted-tournaments">
